...
if (isset($_GET['cid'])) $sql="SELECT * FROM links WHERE categoryID=".$_GET['cid']." AND verify=1 order by `order`";
else $sql="SELECT * FROM links WHERE verify=1";
...
while($row=$result->fetch_array())
{
	...
	echo "<a href=deletelink.php?id=$id>删除</a>";
	echo "</li>";
}
?>
</ul>
